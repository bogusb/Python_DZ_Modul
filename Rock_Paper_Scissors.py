...
while game:
    ...
    for i in range(1, rounds + 1):
        ...
        while player2_choice != 's' and player2_choice != 'p' and player2_choice != 'r' and player1_choice != 'l' and player1_choice != 'k':
            if game_type == 'pvp':
                player2_choice = str(input(f"Enter your choice {player2_name}: [s] [p] [r] [l] [k] : "))
            elif game_type == 'pve':
                player2_name = random.choice('sprlk')  # Выбирает 1 символ l - lizard, k - Spock
